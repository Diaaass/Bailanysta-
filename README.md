...
**Сквозные** — двенадцать сценариев в настоящем браузере поверх production-сборки: регистрация, публикация, редактирование, лайк с проверкой после перезагрузки, комментарий, подписка и переключение ленты, правка профиля, поиск, переключение темы, защита маршрутов. Каждый спек заводит собственных пользователей со случайными именами, поэтому прогоны не мешают друг другу.
...
20 коммитов, около 6704 строк, 10 страниц, 13 API-эндпоинтов, 22 компонентов, 72 теста плюс 12 сквозных сценариев.
